...
import {
  uploadDocument, listDocuments, getDocumentUrl, deleteDocument, updateDocument,
  listDocAccess, addDocAccess, removeDocAccess,
...
router.get('/:id/acceso', asyncHandler(listDocAccess));
router.post('/:id/acceso', asyncHandler(addDocAccess));
router.delete('/:id/acceso/:userId', asyncHandler(removeDocAccess));
